...
def minimum_benchmark():

    '''
    Benchmark minimum from scratch vs NumPy.
    '''
    ...
    from_scratch_time = timeit.timeit(lambda: minimum(numbers_list), number=1000)
    numpy_time = timeit.timeit(lambda:  np.min(numbers), number=1000)
