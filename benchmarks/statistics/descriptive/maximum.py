...
def maximum_benchmark():

    '''
    Benchmark maximum from scratch vs NumPy.
    '''
    ...
    from_scratch_time = timeit.timeit(lambda: maximum(numbers_list), number=1000)
    numpy_time = timeit.timeit(lambda: np.max(numbers), number=1000)
